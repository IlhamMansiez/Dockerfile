...
echo '
        •• Cloning Repository
'
git clone https://github.com/IlhamMansiez/PetercordPanda.git /root/IlhamMansiez/
...
pip install -r /root/IlhamMansiez/requirements.txt
...
echo "
	   ...
	   •• Give build logs in @ilhammansiez if build fails
"
